...
#5. ZSH="$HOME/.config/oh-my-zsh" sh -c "$(curl -fsSL https://raw.githubusercontent.com/ohmyzsh/ohmyzsh/master/tools/install.sh)" "" --unattended
#6. clone repo, but bare. see https://www.atlassian.com/git/tutorials/dotfiles
#7. if all goes well, repo files should go in their right spot!
